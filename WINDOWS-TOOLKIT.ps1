...
$categories = @{
    ...
    "4" = @{ 
        ...
        Files = @(
            ...
            @{Name="TreeSize-Setup.exe"; Url="https://github.com/GlitchLinux/WINDOWS-SOFTWARE/raw/refs/heads/main/PT4/TreeSizeFreeSetup.exe"
            @{Name="TreeSize-Portable.zip"; Url="https://github.com/GlitchLinux/WINDOWS-SOFTWARE/raw/refs/heads/main/PT4/TreeSizeFree-Portable.zip"
